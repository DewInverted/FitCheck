...
export default function Onboarding({ onComplete }: Props) {
  ...
  // Filter styles by selected gender
  const filteredStyles = STYLE_PRESETS.filter(s => s.gender === "all" || s.gender === gender);
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 max-w-md mx-auto w-full">
        ...
        {step === 1 && (
          <div className="w-full animate-fade-up">
            ...
            <p className="text-[14px] text-white/40 mb-8">So we can tailor styles, categories, and suggestions for you</p>
            ...
            <button onClick={() => { if (gender) { setStyle(""); setStep(2); } }} disabled={!gender}
